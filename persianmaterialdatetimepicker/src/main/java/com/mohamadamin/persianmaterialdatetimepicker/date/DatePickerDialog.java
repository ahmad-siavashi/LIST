...
public class DatePickerDialog extends DialogFragment implements
     ...
     */
    private boolean isTodayButtonVisible = false;
    private OnDateSetListener onTodayClickListener = null;
    public static DatePickerDialog newInstance(OnDateSetListener callBack, boolean isTodayButtonVisible, OnDateSetListener onTodayDateSetListener, int year,
            int monthOfYear, 
            int dayOfMonth) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.isTodayButtonVisible = isTodayButtonVisible;
        ret.onTodayClickListener = onTodayDateSetListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        todayButton.setVisibility(isTodayButtonVisible?View.VISIBLE:View.GONE);
        todayButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                PersianCalendar persianCalendar = new PersianCalendar();
                persianCalendar.setTime(new Date());
                onTodayClickListener.onDateSet(DatePickerDialog.this, persianCalendar.getPersianYear(), persianCalendar.getPersianMonth(), persianCalendar.getPersianDay());
                dismiss();
            }
        });
